...
function Reviews() {
  ...
  return (
    <div id="reviews" className='min-h-[80vh] p-8 bg-[#FFC600] flex flex-col items-center gap-y-8 font-shortStack'>
      <h1 className='w-fit text-4xl sm:text-5xl font-bold'>Reviews</h1>
      <div className='flex flex-col sm:flex-row gap-6 w-4/5'>
        {reviews.map((review, ind) =>
          <div key={ind} className='rounded-md bg-orange-500 p-4 flex flex-col gap-y-3 w-full'>
